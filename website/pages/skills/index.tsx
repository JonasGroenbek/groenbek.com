  ...
  return (
    <div id='skills' className='w-full lg:h-screen p-2'>
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        ...
        I gravitate towards the intricacies of software development, especially when it comes to applying architectural designs and patterns.
        I have worked with many technologies; some usually make a more significant impression than others. 
        Below is a list of some I am proficient with and would use for a future project.
          </p>
